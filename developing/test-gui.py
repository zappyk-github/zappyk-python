...
class Example2(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        tarsourcepath="tar tvpf " + self.path1
        self.process.setArguments(QtCore.QStringList.split(" ",tarsourcepath))
        self.process.start()

    def readOutput(self):
        self.textBrowser2.append(QtCore.QString(self.process.readStdout()))
        if self.process.isRunning()==False:
            self.textBrowser2.append("\n Completed Successfully")

    def readErrors(self):
        self.textBrowser2.append("error: " + QtCore.QString(self.process.readLineStderr()))
