...
tag_path_find = _string._removeFirstEmptyLine(tag_path_find)
tag_path_find = _string._stringToList(tag_path_find)
tag_path_desc = conf.get       ("SearchPaths", "tag_path_desc", fallback=tag_path_desc)
tag_path_desc = _string._removeFirstEmptyLine(tag_path_desc)
tag_path_desc = _string._stringToList(tag_path_desc)
...
#CZ#for file_find in _os_file._fileListDir(path_find):
    for name_find in _os_file._nameListDir(path_find):
        if _string._search(tag_name_regx, name_find):
