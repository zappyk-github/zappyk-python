...
from googleSheets.GoogleSheets import *
...
class parser_args(object):
    ...
    #CZ#pgroup.add_argument('-s'     , '--square'        , help='display a square of a given number', type=int)
        ...
        parser.add_argument('-a'     , '--action'        , help='action for Read/Write spreadsheet' , type=str, choices=['r','w']  , default='r', required=True)
        ...
        parser.add_argument('-dl'    , '--dirlabel'      , help='name to assign label spreadsheet'  , type=str                     , default='')
