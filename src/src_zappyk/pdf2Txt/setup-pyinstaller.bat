...
set name_prog=Pdf2Txt
set prog_main=Pdf2Txt\main.py
set file_gear=images\gear.ico
set file_vers=setup-pyinstaller-version.txt

set verp_dist=.\dist\Pdf2Txt.exe
set verp_vers=0.2.0.0
set verp_desc=Turn a report in TXT to a CSV/XLS file
set verp_prod=Pdf2Txt
