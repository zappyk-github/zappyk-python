...
########################################################################################################################
file_type_map = str(sys.argv[1]) if len(sys.argv) > 1 else None
file_name_PDF = str(sys.argv[2]) if len(sys.argv) > 2 else None
file_name_CSV = str(sys.argv[3]) if len(sys.argv) > 3 else None
########################################################################################################################
########################################################################################################################
