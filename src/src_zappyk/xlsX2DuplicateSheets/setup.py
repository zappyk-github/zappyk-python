...
from XLSx2DuplicateSheets.xlsX2duplicate_sheets import _project, _description, _version

#CZ#project = 'XLSx2DuplicateSheets'
...
path_execute = [name]
name_execute = 'xlsX2duplicate_sheets.py'
