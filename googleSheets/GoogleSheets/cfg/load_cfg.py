...
class parser_args(object):
    ...
    #CZ#pgroup.add_argument('-s'     , '--square'  , help='display a square of a given number', type=int)
        ...
        parser.add_argument('-on'    , '--openname', help='open spreadsheet by NAME'          , action='store_true')
        parser.add_argument('-ok'    , '--open_key', help='open spreadsheet by KEY'           , action='store_true')
        parser.add_argument('-ou'    , '--open_url', help='open spreadsheet by URL'           , action='store_true')
