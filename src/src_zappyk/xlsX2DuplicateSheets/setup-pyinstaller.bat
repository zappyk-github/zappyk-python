...
set name_prog=XLSx2DuplicateSheets
set prog_main=XLSx2DuplicateSheets\xlsX2duplicate_sheets.py
set file_gear=images\gear.ico
set file_vers=setup-pyinstaller-version.txt

set verp_dist=.\dist\XLSx2DuplicateSheets.exe
set verp_vers=0.1
set verp_desc=Return disk usage statistics about the given path.
set verp_prod=XLSx2DuplicateSheets
set verp_copy=zappyk@gmail.com, 2019
